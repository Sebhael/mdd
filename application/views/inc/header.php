...
<div data-role="page">
	...
	<div id="mobile-head" data-role="header">
		...
		<a href="./index.php/portal/nav" data-role="button" data-mini="true" data-icon="grid" data-transition="flip" data-theme="a" data-inline="true" id="nav-btn" class="ui-btn-right">Menu</a>
	</div><!-- /header -->
    ...
    <ul>
        <li id="expand">
        	<?php
        		...
        		{
        		?>
        		<a href="./index.php/auth" data-transition="flip" id="login-btn">Login</a>
        		<?php
        		}
        		else
        		{
