...
--
-- Host: localhost
-- Generation Time: Mar 27, 2013 at 09:49 PM
...
INSERT INTO `tasks` (`id`, `title`, `slug`, `notes`, `duedate`, `duetime`, `project`, `owner`, `access`, `created`, `edited`, `completed`, `completed_stamp`, `reported`) VALUES
